...
package i2c_env_pkg;
  ...
  function automatic int get_watermark_bytes_by_level(
      int lvl
  );
    case (lvl)
      0: return 1;
      ...
      default: begin
        `uvm_fatal(
            "i2c_env_pkg::get_watermark_bytes_by_level", $sformatf(
  ...
  function automatic int get_break_bytes_by_level(
      int lvl
  );
    case (lvl)
      0: return 2;
      ...
      default: begin
        `uvm_fatal(
            "i2c_env_pkg::get_break_bytes_by_level", $sformatf(
  ...
  function automatic int get_timing_values_by_speed_mode(
      int speed_mode
  );
    // TODO
  ...
  function automatic int get_speed_mode_by_timing_values(
      int timing0, int timing1, int timing2, int timing3, int timing4, int timing5
  );
    // TODO
