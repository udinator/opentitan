...
class aes_seq_item extends uvm_sequence_item;
  ...
  constraint c_key_size {
    key_size inside {3'b001, 3'b010, 3'b100};
  // key len 0: 128, 1: 192, 2: 256 3: NOT VALID
  }

  constraint c_mode_reg {
    mode == 0;
    man_trigger == 0;
    allow_data_ovrwrt == 0;
  }
  ...
  virtual function bit do_compare(uvm_object rhs, uvm_comparer comparer);
    ...
    return (super.do_compare(rhs, comparer) && (mode == rhs_.mode) && (data_in == rhs_.data_in) && (
            key == rhs_.key) && (data_out == rhs_.data_out));
  endfunction  // compare
